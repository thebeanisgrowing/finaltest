document.addEventListener("DOMContentLoaded", function(){
    ...
    //버튼을 눌러서 랜덤결과 보기
    var urlArray = [];
    urlArray[0] = "result1.html";
    urlArray[1] = "result2.html";
    urlArray[2] = "result3.html";
    urlArray[3] = "result4.html";
    urlArray[4] = "result5.html";
    urlArray[5] = "result6.html";
    
    const space = 3;
    let num = 1;
    console.log(urlArray[parseInt(Math.random(space) * space)]);
    
    document.getElementById("button").onclick = function(){
    this.setAttribute('href', urlArray[parseInt(Math.random(space) * space)]);
    }
    //이미지 슬라이드
